    ...
    <>
      ...
      <div className="p-4 border-t border-brand-border space-y-4">
        ...
        <button
          ...
          className="w-full flex items-center gap-3 px-4 py-3 rounded-lg text-sm font-medium text-brand-danger/80 hover:text-brand-danger hover:bg-brand-danger/5 transition-all group"
        >
